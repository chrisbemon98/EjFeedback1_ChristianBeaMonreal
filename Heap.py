class Heap:
    ...
    def _sink_down(self, index):
        ...
        while True:
            ...
            if left_child_index < size and self.compare(self.heap[above_element_index], self.heap[left_child_index]):
                above_element_index = left_child_index

            if right_child_index < size and self.compare(self.heap[above_element_index], self.heap[right_child_index]):
                above_element_index = right_child_index

            if above_element_index != index:
                self.heap[above_element_index], self.heap[index] = self.heap[index], self.heap[above_element_index]
